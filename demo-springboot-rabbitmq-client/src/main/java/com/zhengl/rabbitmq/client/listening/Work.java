...
public class Work {
    ...
    @RabbitListener(queues = QueueConstant.WORK)
    public void work(String msg, Channel channel, Message message){
    ...
    @RabbitListener(queues = QueueConstant.WORK)
    public void work_1(String msg, Channel channel, Message message){
        long deliveryTag = message.getMessageProperties().getDeliveryTag();
        try {
            // 睡眠100毫秒,默认处理性能差
            Thread.sleep(100);
